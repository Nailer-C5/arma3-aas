...
#define MAP_NAME "[AAS07]CQB Charlie On The Rocks" //Match with intel title from editor
#define MAP_DESCRIPTION "Advance and Secure" //Leave this as is here and in intel
#define MAP_AUTHOR "Huntress Diana [C5]" //Put your name here and take mine out
