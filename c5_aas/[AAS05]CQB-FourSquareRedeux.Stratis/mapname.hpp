...
#define MAP_NAME "[AAS05]CQB Four Square Reduex" //Match with intel title from editor
#define MAP_DESCRIPTION "Advance and Secure" //Leave this as is here and in intel
#define MAP_AUTHOR "Originally by Cowboy, Redone by Mopit[C5]" //Put your name here and take mine out
