...
#define MAP_NAME "[AAS09]CQB Athirean Sunset Meets the Art of War" //Match with intel title from editor
#define MAP_DESCRIPTION "Advance and Secure" //Leave this as is here and in intel
#define MAP_AUTHOR "HuntressDiana[C5]" //Put your name here and take mine out




#define AAS_MEDIUM_MISSION
