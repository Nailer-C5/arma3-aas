/*/ 
File: fn_dropBulwark
Description: Actor for the bulwark "Drop" action menu item.
Domain: Client
/*/
...
[_emptyCrate, ["<t color='#00ffff'>" + "Pickup", bulc_fnc_moveBulwark,"",1,false,false,"true","true",2.5]] remoteExec ["addAction", 0];
