...
[
	...
	[
		...
		'[_this select 0, _this select 1] call bulc_fnc_sell;',
...
[
	...
	[
		...
		'[_this select 0, _this select 3, _this select 1] call bulc_fnc_move;',
...
[
	...
	[
		...
		'[_this select 0, _this select 1] call bulc_fnc_pickup;',
		[0,0,0.5],2,false,false,'true','true',5
	]
] remoteExec ['addAction', 0];
...
[
	...
	[
		...
		'[_this select 0, _this select 1] call bulc_fnc_reset;',
		[0,0,0.5],2,false,false,'true','true',5
	]
] remoteExec ['addAction', 0];
...
sleep 0.1;
[_object] remoteExec ["buls_fnc_solidobject", 2];