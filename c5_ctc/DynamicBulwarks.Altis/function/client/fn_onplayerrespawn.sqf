...
//@TODO this needs to be split into init
...
[player, ['Take', {
  ...
  [_container] remoteExecCall ["bulc_fnc_deleteEmpty", 2];
...
player setPosASL ([bulwarkBox] call bulc_fnc_findPlaceAround);
...
[] remoteExec ["bulc_fnc_updateHud", 0];
