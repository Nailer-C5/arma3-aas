...
_vec addAction["Spawn an MRAP (LIMIT 6)", "mopit_vehicles\SpawnCarHMG.sqf", nil, 6, true, true, "", "true", 2];	
...
_vec addAction["Spawn an Attack Plane (LIMIT 1)", "mopit_vehicles\SpawnAttackPlane.sqf", nil, 6, true, true, "", "true", 2];					
