#define MAP_DESCRIPTION "aas_ILcA_030_055_Sand_Box_Rumble by"
...
#define AAS_DEFAULT_FOG 0.45				//Туман по умолчанию 0 чисто, 1 - сильнейший туман
#define AAS_DEFAULT_TIME_HOUR 5		//Время по умолчанию
