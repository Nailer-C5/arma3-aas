#define MAP_DESCRIPTION "aas_IB_025_120_Chernogorsk_Conflict by "
...
#define dst 1200 						// Дистанция обзора в метрах
#define mzl 0.07						//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
