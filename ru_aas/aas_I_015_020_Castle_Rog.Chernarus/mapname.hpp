#define MAP_DESCRIPTION "aas_I_015_020_Castle_Rog by"
...
#define AAS_DEFAULT_TIME_HOUR 16		//Время по умолчанию
#define AAS_DEFAULT_TIME_MINUTE 45		//Минуты по умолчанию
#define dst 500 						// Дистанция обзора в метрах
#define mzl 0.105							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
