...
[ 4, TEAM_BLUE   , SPAWN_QUEUE, [3,5,6]  , []    , 1     ],
[ 5, TEAM_NEUTRAL, SPAWN_QUEUE, [4,7]    , [6]   , 1     ],
[ 6, TEAM_NEUTRAL, SPAWN_QUEUE, [4,7]    , [5]   , 1     ],
[ 7, TEAM_RED    , SPAWN_QUEUE, [5,6,8]  , []    , 1     ],
[ 8, TEAM_RED    , SPAWN_QUEUE, [7,9]    , []    , 1     ],
[ 9, TEAM_RED    , SPAWN_QUEUE, [8,10]   , []    , 1     ],
[ 10, TEAM_RED   , SPAWN_XRAY , [9]      , []    , 1     ]
];
saas_basecache =
[
[  0 , 0        , 0       , 0      , 100         , []    , 0     , false    ],
