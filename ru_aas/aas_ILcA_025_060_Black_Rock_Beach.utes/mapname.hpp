#define MAP_DESCRIPTION "aas_ILcA_025_060_Black_Rock_Beach by"
...
#define AAS_DEFAULT_FOG 0.13				//Туман по умолчанию 0 чисто, 1 - сильнейший туман
...
#define mzl 0.23							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
