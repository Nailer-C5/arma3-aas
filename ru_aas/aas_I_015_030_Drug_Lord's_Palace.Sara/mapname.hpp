#define MAP_DESCRIPTION "aas_I_015_030_Drug_Lord's_Palace by A2RU"

#define OVERVIEWTEXT $STR_AAS_HISTORY

#define AAS_SMALL_MISSION

#define AAS_DEFAULT_WEATHER 0.01			//Погода по умолчанию - 0 -чисто. 1 - штормовая (ваврьируется от 0 до 1)
#define AAS_DEFAULT_FOG 0.005				//Туман по умолчанию 0 чисто, 1 - сильнейший туман
#define AAS_DEFAULT_TIME_HOUR 15		//Время по умолчанию
#define AAS_DEFAULT_TIME_MINUTE 15		//Минуты по умолчанию
#define dst 600 						// Дистанция обзора в метрах
#define mzl 0.02							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
