#define MAP_DESCRIPTION "aas_IL_010_040_To_Sea by LEGYICH"

#define OVERVIEWTEXT $STR_AAS_HISTORY

#define AAS_SMALL_MISSION

#define AAS_DEFAULT_WEATHER 0.3			//Погода по умолчанию - 0 -чисто. 1 - штормовая (ваврьируется от 0 до 1)
...
#define dst 700 						// Дистанция обзора в метрах
