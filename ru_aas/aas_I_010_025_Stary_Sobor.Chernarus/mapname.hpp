#define MAP_DESCRIPTION "aas_I_010_025_Stary_Sobor by ClubArmaholics"
...
#define mzl 0.038							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
