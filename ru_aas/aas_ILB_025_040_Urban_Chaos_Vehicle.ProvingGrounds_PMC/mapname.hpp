#define MAP_DESCRIPTION "aas_ILB_025_040_Urban_Chaos_Vehicle by BBQ"
...
#define mzl 0.35							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
