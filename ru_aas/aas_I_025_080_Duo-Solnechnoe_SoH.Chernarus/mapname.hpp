#define MAP_DESCRIPTION "aas_I_025_080_Duo-Solnechnoe by SoH SQUAD"
...
#define mzl 0.035							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
