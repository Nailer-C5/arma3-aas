#define MAP_DESCRIPTION "aas_IL_030_060_Cam_Ran_BIG by ASSA"
...
#define dst 750 						// Дистанция обзора в метрах
#define mzl 0.075							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
