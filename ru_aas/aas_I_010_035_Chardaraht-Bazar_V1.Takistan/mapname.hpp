#define MAP_DESCRIPTION "aas_I_010_035_Chardaraht-Bazar_V1 by ASSA [RUS]"

#define OVERVIEWTEXT $STR_AAS_HISTORY

#define AAS_SMALL_MISSION

#define AAS_DEFAULT_WEATHER 0.2			//Погода по умолчанию - 0 -чисто. 1 - штормовая (ваврьируется от 0 до 1)
#define AAS_DEFAULT_FOG 0.8				//Туман по умолчанию 0 чисто, 1 - сильнейший туман
#define AAS_DEFAULT_TIME_HOUR 04		//Время по умолчанию
#define AAS_DEFAULT_TIME_MINUTE 20		//Минуты по умолчанию
#define dst 800 						// Дистанция обзора в метрах
#define mzl 0.028							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
