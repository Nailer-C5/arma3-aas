#define MAP_DESCRIPTION "aas_ILB_050_080_Canyon_of_Death by SoH SQUAD"
...
#define mzl 0.077							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
