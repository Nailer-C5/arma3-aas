#define MAP_DESCRIPTION "aas_I_015_03_Coastal_Town_2 by Nightrider[C5]"
...
#define mzl 0.042							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
