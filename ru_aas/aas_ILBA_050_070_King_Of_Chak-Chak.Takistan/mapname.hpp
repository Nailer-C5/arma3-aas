#define MAP_DESCRIPTION "aas_ILBA_050_070_King_Of_Chak-Chak by BCA quattro"
...
#define AAS_DEFAULT_TIME_HOUR 18		//Время по умолчанию
#define AAS_DEFAULT_TIME_MINUTE 40		//Минуты по умолчанию
#define dst 1000 						// Дистанция обзора в метрах
#define mzl 0.15							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
