...
[ 4, TEAM_BLUE   , SPAWN_QUEUE, [3,5]  , []    , 1     ],
[ 5, TEAM_BLUE   , SPAWN_QUEUE, [4,6,7]  , []    , 1     ],
[ 6, TEAM_NEUTRAL, SPAWN_QUEUE, [5,8]    , [7]   , 1     ],
[ 7, TEAM_NEUTRAL, SPAWN_QUEUE, [5,8]    , [6]   , 1     ],
[ 8, TEAM_RED    , SPAWN_QUEUE, [6,7,9]  , []    , 1     ],
[ 9, TEAM_RED    , SPAWN_QUEUE, [8,10]    , []    , 1     ],
[ 10, TEAM_RED    , SPAWN_QUEUE, [9,11]   , []    , 1     ],
[ 11, TEAM_RED    , SPAWN_QUEUE, [10,12]   , []    , 1     ],
[ 12, TEAM_RED   , SPAWN_XRAY , [11]      , []    , 1     ]
];
saas_basecache =
[
[  0 , 0        , 0       , 0      , 100         , []    , 0     , false    ],
