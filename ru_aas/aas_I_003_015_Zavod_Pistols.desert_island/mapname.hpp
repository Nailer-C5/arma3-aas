#define MAP_DESCRIPTION "aas_I_003_015_Zavod_Pistols by Limon27"

#define OVERVIEWTEXT $STR_AAS_HISTORY

#define AAS_SMALL_MISSION

#define AAS_DEFAULT_WEATHER 0.6			//Погода по умолчанию - 0 -чисто. 1 - штормовая (ваврьируется от 0 до 1)
#define AAS_DEFAULT_FOG 0.63				//Туман по умолчанию 0 чисто, 1 - сильнейший туман
#define AAS_DEFAULT_TIME_HOUR 05		//Время по умолчанию
#define AAS_DEFAULT_TIME_MINUTE 37		//Минуты по умолчанию
#define dst 300 						// Дистанция обзора в метрах
#define mzl 0.015							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
...
#define boecgp false		// 1 рюкзак не положен (0 - боец)
#define macpso false		// 2
#define machgn false		// 3
#define sanit  true		// 4
#define remont false	    // 5
#define rshg   false		// 6
#define rpg7   false		// 7
