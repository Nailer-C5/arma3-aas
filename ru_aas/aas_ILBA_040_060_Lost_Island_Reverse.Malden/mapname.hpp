#define MAP_DESCRIPTION "aas_ILBA_040_060_Lost_Island_Reverse by ClubArmaholics"
...
#define AAS_DEFAULT_TIME_HOUR 17		//Время по умолчанию
#define AAS_DEFAULT_TIME_MINUTE 45		//Минуты по умолчанию
#define dst 1500 						// Дистанция обзора в метрах
