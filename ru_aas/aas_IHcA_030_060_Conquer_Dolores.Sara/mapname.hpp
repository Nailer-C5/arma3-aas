#define MAP_DESCRIPTION "aas_IHcA_030_060_Conquer_Dolores by ClubArmaholics"
...
#define AAS_DEFAULT_TIME_HOUR 14		//Время по умолчанию
#define AAS_DEFAULT_TIME_MINUTE 19		//Минуты по умолчанию
#define dst 2500 						// Дистанция обзора в метрах
