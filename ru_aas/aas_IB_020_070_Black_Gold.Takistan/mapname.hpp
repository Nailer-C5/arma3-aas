#define MAP_DESCRIPTION "aas_IB_020_070_Black_Gold by [TG]Flightster"
...
#define mzl 0.12							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
