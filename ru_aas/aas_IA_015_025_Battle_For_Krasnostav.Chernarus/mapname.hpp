#define MAP_DESCRIPTION "aas_IA_015_025_Battle_For_Krasnostav by BCA Cat Toaster"

#define OVERVIEWTEXT $STR_AAS_HISTORY

#define AAS_SMALL_MISSION

#define AAS_DEFAULT_WEATHER 1			//Погода по умолчанию - 0 -чисто. 1 - штормовая (ваврьируется от 0 до 1)
