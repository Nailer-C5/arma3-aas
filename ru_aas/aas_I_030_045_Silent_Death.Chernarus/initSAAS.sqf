...
[ 2, TEAM_BLUE   , SPAWN_QUEUE, [1,3,4]  , []    , 1     ],
[ 3, TEAM_NEUTRAL, SPAWN_QUEUE, [2,5]    , [4]   , 1     ],
[ 4, TEAM_NEUTRAL, SPAWN_QUEUE, [2,5]    , [3]   , 1     ],
[ 5, TEAM_RED    , SPAWN_QUEUE, [3,4,6]  , []    , 1     ],
[ 6, TEAM_RED    , SPAWN_XRAY , [5]      , []    , 1     ]
];
saas_basecache =
[
[  0 , 0        , 0       , 0      , 100         , []    , 0     , false    ],
