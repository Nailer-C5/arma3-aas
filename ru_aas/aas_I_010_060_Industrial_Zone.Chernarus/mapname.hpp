#define MAP_DESCRIPTION "aas_I_010_060_Industrial_Zone by qwertz"

#define OVERVIEWTEXT $STR_AAS_HISTORY

#define AAS_SMALL_MISSION

#define AAS_DEFAULT_WEATHER 0.19			//Погода по умолчанию - 0 -чисто. 1 - штормовая (ваврьируется от 0 до 1)
#define AAS_DEFAULT_FOG 0.16				//Туман по умолчанию 0 чисто, 1 - сильнейший туман
#define AAS_DEFAULT_TIME_HOUR 13		//Время по умолчанию
