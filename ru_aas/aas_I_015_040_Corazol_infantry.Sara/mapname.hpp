#define MAP_DESCRIPTION "aas_I_015_040_Corazol_infantry by ClubArmaholics"
...
#define AAS_DEFAULT_TIME_HOUR 8		//Время по умолчанию
#define AAS_DEFAULT_TIME_MINUTE 13		//Минуты по умолчанию
