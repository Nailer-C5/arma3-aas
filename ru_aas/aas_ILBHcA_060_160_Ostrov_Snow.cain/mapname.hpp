#define MAP_DESCRIPTION "aas_ILBHcA_06_16_Ostrov_Snow by [HA]Galactic"

#define OVERVIEWTEXT $STR_AAS_HISTORY

#define AAS_LARGE_MISSION

#define AAS_DEFAULT_WEATHER 0.73			//Погода по умолчанию - 0 -чисто. 1 - штормовая (ваврьируется от 0 до 1)
#define AAS_DEFAULT_FOG 0				//Туман по умолчанию 0 чисто, 1 - сильнейший туман
#define AAS_DEFAULT_TIME_HOUR 10		//Время по умолчанию
#define AAS_DEFAULT_TIME_MINUTE 08		//Минуты по умолчанию
#define dst 3500 						// Дистанция обзора в метрах
#define mzl 0.27							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
...
#define agsm   true		// 10
#define Jav    true		// 11
#define pzrk1  true		// 12
#define snip   true		// 13
#define spez   true		// 14
#define saper  true		// 15
#define zavdv  true		// 16
#define opbpla true	 	// 17
