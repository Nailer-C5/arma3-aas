#define MAP_DESCRIPTION "aas_ILA_055_170_Krasnostav_Advance by"
...
#define mzl 0.21							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
