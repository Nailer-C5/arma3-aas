#define MAP_DESCRIPTION "aas_ILH_020_080_Island_DUO by ASSA [RUS]"
...
#define AAS_DEFAULT_TIME_MINUTE 30		//Минуты по умолчанию
#define dst 900 						// Дистанция обзора в метрах
#define mzl 0.05							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
