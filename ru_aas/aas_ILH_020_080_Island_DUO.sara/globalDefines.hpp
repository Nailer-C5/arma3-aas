...
#define SHORT_VERSION "ver.Arma2.ru"    // version string displayed at bottom of screen
...
#define BOOTHILLCAMP_RADIUS 250        // min distance from boot hill before taking damage
#define HINT_INTERVAL (90 + random 90)  // how often do hints come
...
#define CL_LIMIT       9
#define CL_WESTUNIFORMS  10
#define CL_EASTUNIFORMS  11
#define CL_WESTVESTS  12
#define CL_EASTVESTS  13
#define CL_WESTBACKBACKS  14
#define CL_EASTBACKBACKS  15
#define CL_WESTBINOS  16
#define CL_EASTBINOS  17
#define CL_WESTGOGGLES 18
#define CL_EASTGOGGLES 19
#define CL_WESTHEADGEARS 20
#define CL_EASTHEADGEARS 21
#define CL_WESTITEMS     22
#define CL_EASTITEMS     23
#define CL_PRIITEMS    24
#define WL_PRINTEDNAME 0
#define WL_NAME        1
#define WL_MAGLIST     2
#define CHOOSER_DURATION 8 // number of seconds for which chooser menu stays visible after a keypress
...
#define QUOTEME(x) #x
#define AAS_DEFAULT_TIME_HOUR_MACRO(h) QUOTEME($STR_AAS_Mission_Default_h)
#define AAS_DEFAULT_TIME_MINUTE_MACRO(m) QUOTEME($STR_AAS_Mission_Default_m)
#define AAS_DEFAULT_WEATHER_MACRO(weather) QUOTEME($STR_AAS_Mission_Default_weather)
#define AAS_DEFAULT_FOG_MACRO(fog) QUOTEME($STR_AAS_Mission_Default_fog)
#define SETUP_ZEL      0
#define SETUP_PES      1
#define SETUP_GUNS	   2
#define SETUP_GAL	   3	
