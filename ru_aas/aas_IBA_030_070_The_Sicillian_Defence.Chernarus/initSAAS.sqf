...
[
[ 0, 0           , 0          , []       , []    , 1     ],
[ 1, TEAM_BLUE   , SPAWN_XRAY , [2,3]    , []    , 1     ],
[ 2, TEAM_BLUE   , SPAWN_QUEUE, [1,4]    , [3]   , 1     ],
[ 3, TEAM_BLUE   , SPAWN_QUEUE, [1,4]    , [2]   , 1     ],
[ 4, TEAM_BLUE   , SPAWN_QUEUE, [2,3,5]  , []    , 1     ],
[ 5, TEAM_RED    , SPAWN_QUEUE, [6,7,4]  , []    , 1     ],
[ 6, TEAM_RED    , SPAWN_QUEUE, [5,8]    , [7]   , 1     ],
[ 7, TEAM_RED    , SPAWN_QUEUE, [5,8]    , [6]   , 1     ],
[ 8, TEAM_RED    , SPAWN_XRAY , [6,7]    , []    , 1     ]
];
saas_basecache =
[
[  0 , 0        , 0       , 0      , 100         , []    , 0     , false    ],
