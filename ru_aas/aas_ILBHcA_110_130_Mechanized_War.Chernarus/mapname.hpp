#define MAP_DESCRIPTION "aas_ILBHcA_110_130_Mechanized_War By Grimes [3rd ID]"
...
#define dst 3600 						// Дистанция обзора в метрах
#define mzl 0.14							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
