#define MAP_DESCRIPTION "aas_ILBA_020_190_Komarovo by LEGYICH"

#define OVERVIEWTEXT $STR_AAS_HISTORY

#define AAS_SMALL_MISSION

#define AAS_DEFAULT_WEATHER 0.4			//Погода по умолчанию - 0 -чисто. 1 - штормовая (ваврьируется от 0 до 1)
#define AAS_DEFAULT_FOG 0.26				//Туман по умолчанию 0 чисто, 1 - сильнейший туман
