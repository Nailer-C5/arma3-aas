#define MAP_DESCRIPTION "aas_I_015_035_Moyevka_2018"
...
#define AAS_DEFAULT_FOG 0.12				//Туман по умолчанию 0 чисто, 1 - сильнейший туман
#define AAS_DEFAULT_TIME_HOUR 06		//Время по умолчанию
...
//Кому рюкзак не положен. Если выключаем класс, соответственно надо изменить циф
