#define MAP_DESCRIPTION "aas_I_02_025_Castle_At_Thronos by Nightrider[C5]"
...
#define mzl 0.063							//Размер карты HUD  для примера - малые карты 0.1, средние - 0.2, большие 0.3 и больше
