...
class Respawn_Cancel: RespawnButtonBase	{idc = 62; x = 0.85; y = 0.20; action = "[99,player] execVM 'clickSpawnButton.sqf';"; text = "$STR_AAS_Cancel";};
...
class Queue_10 : QueueListBase   {     idc = 41; 	x = 0.05;	y = 0.8;    };
	class CancelQueueInfoText: RscText
	{
		...
		h = 0.04;
		sizeEx = 0.035;
		text = "$STR_AAS_Click_spawn_queue";
	};
};