#define S3_MISSION_VD 700
#define S3_NAME  Zelenogorsk evenings
...
#define S3_TankSpawn 360
#define S3_HeliSpawn 360
#define S3_PlaneSpawn 360
#define S3_BastardSpawn 600

#define S3_MISSION_Rules 0